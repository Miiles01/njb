...
const translations = {
    es: {
        ...
        'stacked.clientes.subtitle': 'Trabajamos con empresas en:',
        'stacked.clientes.item1': '🇨🇦 Canadá',
        'stacked.clientes.item2': '🇺🇸 Estados Unidos',
        'stacked.clientes.item3': '🇲🇽 México',
        'stacked.clientes.footer': '👉 Ayudándolas a crecer localmente y escalar internacionalmente.',
        'stacked.resultados.title': '📊 Resultados',
        'stacked.resultados.subtitle': 'Números reales. Crecimiento real.',
        'stacked.resultados.item1': '+18 conversiones = $570 generados (inicio de campaña)',
        'stacked.resultados.item2': 'Incremento en reservas e interacción',
        'stacked.resultados.item3': 'Experiencia en múltiples mercados',
        'stacked.resultados.footer': '👉 (Agrega screenshots aquí)',
        'stacked.contenido.title': '🎥 Contenido',
        'stacked.contenido.subtitle': 'La gente no compra publicidad. Compra lo que ve.',
        'stacked.contenido.item1': 'Videos cinematográficos',
        'stacked.contenido.item2': 'Tomas con drone',
        'stacked.contenido.item3': 'Storytelling',
        'stacked.contenido.item4': 'Contenido optimizado para redes',
        'stacked.proceso.title': '⚙️ Proceso',
        'stacked.proceso.item1': '1. Auditoría y estrategia',
        'stacked.proceso.item2': '2. Creación de contenido',
        'stacked.proceso.item3': '3. Lanzamiento de campañas',
        'stacked.proceso.item4': '4. Optimización y escalamiento',
    ...
    en: {
        ...
        'stacked.clientes.subtitle': 'We work with companies in:',
        'stacked.clientes.item1': '🇨🇦 Canada',
        'stacked.clientes.item2': '🇺🇸 United States',
        'stacked.clientes.item3': '🇲🇽 Mexico',
        'stacked.clientes.footer': '👉 Helping them grow locally and scale internationally.',
        'stacked.resultados.title': '📊 Results',
        'stacked.resultados.subtitle': 'Real numbers. Real growth.',
        'stacked.resultados.item1': '+18 conversions = $570 generated (campaign start)',
        'stacked.resultados.item2': 'Increase in bookings and interaction',
        'stacked.resultados.item3': 'Experience in multiple markets',
        'stacked.resultados.footer': '👉 (Add screenshots here)',
        'stacked.contenido.title': '🎥 Content',
        'stacked.contenido.subtitle': 'People don\'t buy advertising. They buy what they see.',
        'stacked.contenido.item1': 'Cinematic videos',
        'stacked.contenido.item2': 'Drone shots',
        'stacked.contenido.item3': 'Storytelling',
        'stacked.contenido.item4': 'Social media optimized content',
        'stacked.proceso.title': '⚙️ Process',
        'stacked.proceso.item1': '1. Audit and strategy',
        'stacked.proceso.item2': '2. Content creation',
        'stacked.proceso.item3': '3. Campaign launch',
        'stacked.proceso.item4': '4. Optimization and scaling',
    ...
    fr: {
        ...
        // Stacked Value Section
        'stacked.clientes.title': '🌍 Clients',
        'stacked.clientes.subtitle': 'Nous travaillons avec des entreprises en :',
        'stacked.clientes.item1': '🇨🇦 Canada',
        'stacked.clientes.item2': '🇺🇸 États-Unis',
        'stacked.clientes.item3': '🇲🇽 Mexique',
        'stacked.clientes.footer': '👉 Les aider à croître localement et à se développer à l\'international.',
        'stacked.resultados.title': '📊 Résultats',
        'stacked.resultados.subtitle': 'Des chiffres réels. Une croissance réelle.',
        'stacked.resultados.item1': '+18 conversions = $570 générés (début de campagne)',
        'stacked.resultados.item2': 'Augmentation des réservations et des interactions',
        'stacked.resultados.item3': 'Expérience sur plusieurs marchés',
        'stacked.resultados.footer': '👉 (Ajoutez des captures d\'écran ici)',
        'stacked.contenido.title': '🎥 Contenu',
        'stacked.contenido.subtitle': 'Les gens n\'achètent pas de publicité. Ils achètent ce qu\'ils voient.',
        'stacked.contenido.item1': 'Vidéos cinématographiques',
        'stacked.contenido.item2': 'Prises de vue par drone',
        'stacked.contenido.item3': 'Storytelling',
        'stacked.contenido.item4': 'Contenu optimisé pour les réseaux sociaux',
        'stacked.proceso.title': '⚙️ Processus',
        'stacked.proceso.item1': '1. Audit et stratégie',
        'stacked.proceso.item2': '2. Création de contenu',
        'stacked.proceso.item3': '3. Lancement de campagnes',
        'stacked.proceso.item4': "4. Optimisation et mise à l'échelle",
