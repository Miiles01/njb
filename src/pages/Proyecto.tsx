...
const projectData: Record<string, ProjectContent> = {
  original: {
    ...
    folder: "Original",
    images: [
      { src: "portada-1.webp", alt: "Barbería — Cover", aspect: "wide" },
      { src: "original-1.webp", alt: "Barbería — Style", aspect: "wide" },
      { src: "barberia-new.jpg", alt: "Barbería — Experience", aspect: "wide" },
      { src: "isotipo.webp", alt: "Barbería — Isotipo", aspect: "wide" },
      { src: "fotos-instagram.webp", alt: "Barbería — Instagram", aspect: "wide" },
      { src: "landing-page-1.webp", alt: "Barbería — Landing Page 1", aspect: "wide" },
    ],
  },
  tularosa: {
  ...
  realestate: {
    ...
    description: {
      es: "Desarrollamos la identidad integral para un desarrollo inmobiliario de lujo, enfocándonos en un posicionamiento de exclusividad. Creamos el manual de identidad, activos de marca y una estrategia visual coherente que eleva la percepción de valor de las propiedades, facilitando la conexión con inversionistas de alto nivel.",
      en: "We developed the comprehensive identity for a luxury real estate development, focusing on exclusivity positioning. We created the identity manual, brand assets, and a coherent visual strategy that elevates the value perception of properties, facilitating connection with high-level investors.",
      fr: "Nous avons développé l'identité complète d'un projet immobilier de luxe, en nous concentrant sur un positionnement exclusif. Nous avons créé le manuel d'identité, les actifs de la marque et une stratégie visuelle cohérente qui rehausse la perception de la valeur des propriétés.",
    },
    folder: "Real-Estate",
    images: [
      { src: "item-1.png", alt: "Real Estate — Cover", aspect: "wide" },
      ...
      { src: "portada.jpg", alt: "Real Estate — View", aspect: "wide" },
    ],
  },
  sportswear: {
    title: "Sportswear",
