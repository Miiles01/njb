...
const Hero = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      key={language} 
      className="relative min-h-[70vh] md:min-h-[100vh] flex flex-col justify-center md:justify-between items-center md:items-stretch gap-8 md:gap-0 py-12 md:py-32 px-12 md:px-24 overflow-hidden bg-white"
    >
