...
const Hero = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      key={language} 
      className="relative md:min-h-[100vh] flex flex-col justify-center md:justify-between items-center md:items-stretch gap-6 md:gap-0 pt-24 pb-24 md:py-32 px-12 md:px-24 overflow-hidden bg-white"
    >
